...
| # | Tópico | Arquivo |
|---|---|---|
| 1 | Introdução aos Fundamentos de IA Generativa | [docs/1_Introduction_to_Generative_AI_Fundamentals.md](docs/1_Introduction_to_Generative_AI_Fundamentals.md) |
| 2 | Fundamentos de Deep Learning | [docs/2_Deep_Learning_Fundamentals.md](docs/2_Deep_Learning_Fundamentals.md) |
| 3 | Modelos de Fundação | [docs/3_Foundation_Models.md](docs/3_Foundation_Models.md) |
| 4 | Adaptando Modelos de Fundação | [docs/4_Adapting_Foundation_Models.md](docs/4_Adapting_Foundation_Models.md) |

## 🏋️ Exercícios e Projeto

- **Projeto Principal:** [LightweightFineTuning.ipynb](LightweightFineTuning.ipynb) — Fine-tuning leve com LoRA
- **Script de Inferência:** [SentimentAnalyzer.py](SentimentAnalyzer.py) — Análise de sentimento com modelo fine-tuned
